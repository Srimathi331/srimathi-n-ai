...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Srimathi N" },
      { property: "og:title", content: "Srimathi N — AI Engineer & Software Developer" },
      { property: "og:description", content: "Portfolio of Srimathi N — AI Engineer & SDE building intelligent, scalable products with Generative AI, Computer Vision, and Full-Stack engineering." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Srimathi N — AI Engineer & Software Developer" },
      { name: "twitter:description", content: "Portfolio of Srimathi N — AI Engineer & SDE building intelligent, scalable products with Generative AI, Computer Vision, and Full-Stack engineering." },
    ],
    links: [
